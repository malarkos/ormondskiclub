...
function create_member_list($thisday) {
	...
	$query = "SELECT DISTINCT booking_rooms.memid,members.MemberFirstname, members.MemberSurname FROM booking_rooms,members WHERE booking_rooms.memid = members.memberid and roomnight='$thisday' AND memguest='m' ORDER BY members.MemberSurname";
...
$form .= "<h3>Room & Job Allocations - Please stay in your assigned rooms!</h3>";
...
if (! isset ( $_SESSION ['startdate'] )) {
	$startdate = mktime ( 0, 0, 0, 5, 28, 2017);
...
// $form .= "<td>";
$startselect = mktime ( 0, 0, 0, 5, 28, 2017);
$endselect = mktime ( 0, 0, 0, 10, 1, 2017 );
...
$enddate = mktime ( 0, 0, 0, 10, 2, 2017 );
		...
		if ($num > 0) {
			...
			for($k = 0; $k < $num; $k ++) {
				...
				if (strcmp ( $memguest, 'm' ) == 0) {
					...
					$surname = mysql_result ( $result1, 0, "MemberSurname" );
					mysql_free_result ( $result1 );
					$form .= "<tr><Td class='ms-column3-even1'>$firstname $surname $vegstring</td><td class='ms-column3-even2'>&nbsp</td></tr>";
					...
					mysql_free_result ( $result1 );
					$form .= "<tr><Td class='ms-column3-even1'>$firstname $surname $memberagestring $vegstring $memberinit</td><td class='ms-column3-even2'>&nbsp</td></tr>";
				} else {
					$form .= "<tr><Td class='ms-column3-even1'>$firstname $surname $memberagestring $vegstring $memberinit</td><td class='ms-column3-even2'>&nbsp</td></tr>";
				}
			}
		...
		if ($num > 0) {
			...
			for($k = 0; $k < $num; $k ++) {
				...
				if (strcmp ( $memguest, 'm' ) == 0) {
					...
					$surname = mysql_result ( $result1, 0, "MemberSurname" );
					mysql_free_result ( $result1 );
					$form .= "<tr><Td class='ms-column3-odd1'>$firstname $surname $vegstring</td><td class='ms-column3-odd2'>&nbsp</td></tr>";
				} else if ((strcmp ( $memguest, 'f' ) == 0) || (strcmp ( $memguest, 'c' ) == 0)) {
					$query1 = "select familyMemberFirstname, familyMemberSurname from familymembers where familyMemberID='$memberval'";
					$result1 = mysql_query ( $query1 );
					$firstname = mysql_result ( $result1, 0, "familyMemberFirstname" );
					$surname = mysql_result ( $result1, 0, "familyMemberSurname" );
					mysql_free_result ( $result1 );
					$form .= "<tr><Td class='ms-column3-odd1'>$firstname $surname $memberagestring $vegstring $memberinit</td><td class='ms-column3-odd2'>&nbsp</td></tr>";
				} else {
					$form .= "<tr><Td class='ms-column3-odd1'>$firstname $surname $memberagestring $vegstring $memberinit</td><td class='ms-column3-odd2'>&nbsp</td></tr>";
				}
			}
				...
				if ($xxx == 0) // first night
{
				...
				if (strcmp ( $memguest, 'm' ) == 0) {
					...
					$surname = mysql_result ( $result1, 0, "MemberSurname" );
					mysql_free_result ( $result1 );
					$form .= "<tr><Td class='ms-column3-even1'>$firstname $surname $vegstring$dinnerstring</td><td class='ms-column3-even2'>&nbsp</td></tr>";
				} else if ((strcmp ( $memguest, 'f' ) == 0) || (strcmp ( $memguest, 'c' ) == 0)) {
					$query1 = "select familyMemberFirstname, familyMemberSurname from familymembers where familyMemberID='$memberval'";
					$result1 = mysql_query ( $query1 );
					$firstname = mysql_result ( $result1, 0, "familyMemberFirstname" );
					...
					mysql_free_result ( $result1 );
					$form .= "<tr><Td class='ms-column3-even1'>$firstname $surname $memberagestring $vegstring $dinnerstring $memberinit </td><td class='ms-column3-even2'>&nbsp</td></tr>";
				} else {
					$form .= "<tr><Td class='ms-column3-even1'>$firstname $surname $memberagestring $vegstring $dinnerstring $memberinit</td><td class='ms-column3-even2'>&nbsp</td></tr>";
				}
			}
...
$form .= "Legend: ab - Booking Member,(10) - child age, V  - vegetarian, x is no dinner first night";
$form .= "<table><tr><td class='text2'><A href='bookingadmin.php'>Home</a> -- Show Rooms Allocations</td>"; // </tr></table>";
$form .= "<td><Form action='roomlistviewchange1.php' method='POST'><select name='showweek'>";
